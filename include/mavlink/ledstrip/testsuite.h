/** @file
 *    @brief MAVLink comm protocol testsuite generated from ledstrip.xml
 *    @see https://mavlink.io/en/
 */
#pragma once
#ifndef LEDSTRIP_TESTSUITE_H
#define LEDSTRIP_TESTSUITE_H
...
static void mavlink_test_led_strip_config(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_led_strip_config_t packet1, packet2;
        ...
        packet1.fill_mode = packet_in.fill_mode;
        packet1.led_index = packet_in.led_index;
        packet1.length = packet_in.length;
        packet1.strip_id = packet_in.strip_id;
    ...
    mavlink_msg_led_strip_config_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_led_strip_config_pack(system_id, component_id, &msg , packet1.target_system , packet1.target_component , packet1.fill_mode , packet1.led_index , packet1.length , packet1.strip_id , packet1.colors );
    mavlink_msg_led_strip_config_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_led_strip_config_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.target_system , packet1.target_component , packet1.fill_mode , packet1.led_index , packet1.length , packet1.strip_id , packet1.colors );
    mavlink_msg_led_strip_config_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_led_strip_config_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_led_strip_config_send(MAVLINK_COMM_1 , packet1.target_system , packet1.target_component , packet1.fill_mode , packet1.led_index , packet1.length , packet1.strip_id , packet1.colors );
    mavlink_msg_led_strip_config_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_led_strip_state(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_led_strip_state_t packet1, packet2;
        ...
        packet1.led_index = packet_in.led_index;
        packet1.strip_id = packet_in.strip_id;
        packet1.following_mode = packet_in.following_mode;
    ...
    mavlink_msg_led_strip_state_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_led_strip_state_pack(system_id, component_id, &msg , packet1.length , packet1.led_index , packet1.strip_id , packet1.following_mode , packet1.colors );
    mavlink_msg_led_strip_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_led_strip_state_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.length , packet1.led_index , packet1.strip_id , packet1.following_mode , packet1.colors );
    mavlink_msg_led_strip_state_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_led_strip_state_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_led_strip_state_send(MAVLINK_COMM_1 , packet1.length , packet1.led_index , packet1.strip_id , packet1.following_mode , packet1.colors );
    mavlink_msg_led_strip_state_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
...
static void mavlink_test_ledstrip(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
